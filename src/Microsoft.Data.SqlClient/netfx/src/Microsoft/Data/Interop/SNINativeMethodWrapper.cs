...
namespace Microsoft.Data.SqlClient
{
    internal static class SNINativeMethodWrapper
    {
        ...
        private static uint SNIInitialize([In] bool useSystemDefaultSecureProtocols, [In] IntPtr pmo, [In] bool tlsFirst)
        {
            return s_is64bitProcess ?
                SNINativeManagedWrapperX64.SNIInitialize(useSystemDefaultSecureProtocols, pmo, tlsFirst) :
                SNINativeManagedWrapperX86.SNIInitialize(useSystemDefaultSecureProtocols, pmo, tlsFirst);
        }
        ...
        {
            //  TODO: figure out how to the this tlsFirst into here
            bool tlsFirst = false;
            return SNIInitialize(LocalAppContextSwitches.UseSystemDefaultSecureProtocols, IntPtr.Zero, tlsFirst);
        }
